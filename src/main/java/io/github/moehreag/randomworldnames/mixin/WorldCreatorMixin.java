...
public class WorldCreatorMixin {
	...
	@WrapOperation(method = "<init>", at = @At(value = "FIELD", target = "Lnet/minecraft/client/gui/screens/worldselection/WorldCreationUiState;DEFAULT_WORLD_NAME:Lnet/minecraft/network/chat/Component;", opcode = Opcodes.GETSTATIC))
